<div>
    ...
    <div class="max-w-8xl mx-auto py-10 sm:px-6 lg:px-8">
        <form wire:submit.prevent="submit" class="m-10 mt-0 p-4">
            ...
            <x-jet-input type="text" placeholder="Código" wire:model="code" class="mt-1 block w-full rounded-md"
                required />
            @error('code')
                <p class="text-red-500 font-semibold my-2">
                    {{ $message }}
            ...
            <div wire:ignore class="my-2">
                ...
                <select id="select2-dropdown" wire:model="presentation_id" wire:change="onChangeSelectPresentation"
            ...
            {{-- end select presentation --}}
            {{-- select categories --}}
            <div wire:ignore class="my-2">
                <div class="">
                    Categoría
                </div>
                <select id="select2-dropdown" wire:model="category_id" wire:change="onChangeSelectCategory"
                    class="border-gray-300 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 shadow-sm mt-1 block w-full rounded-md"
                    required>
                    <option selected>(Seleccionar)</option>
            ...
            {{-- photo --}}
            <x-jet-label class="mt-2 mb-2" value="Imagen principal" />
            @if ($photo)
                <div class="mt-2">

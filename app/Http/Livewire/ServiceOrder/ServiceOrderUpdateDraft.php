...
class ServiceOrderUpdateDraft extends Component
{
    use LivewireAlert;
    ...
    public function mount($slug)
    {
        ...
        $this->draft_expiration_date = $this->service_order->draft_expiration_date;
    ...
    {
        return view('livewire.service-order.service-order-update-draft');
    }
